...
<html lang="en">
  <head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Fuggles&family=Merienda:wght@400;700&family=Poppins:wght@400;500;600&display=swap" rel="stylesheet">
  ...
  <body class="bg-light">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white px-lg-3 py-lg-2 shadow-sm sticky-top">
      <div class="container-fluid">
        <a class="navbar-brand me-5 fw-bold fs-3 h-font" href="index.php">Hotel Paradiso</a>
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <form>
            ...
            <div class="modal-body">
              <span class="badge rounded-pill bg-light text-dark mb-3 text-wrap lh-base"> Note: Your details must match with your ID (KTP/Passport/SIM) that will be required during check-in. </span>
              <div class="container-fluid">
                <div class="row">
    ...
    <div class="container-fluid px-lg-4 mt-4">
      ...
      <div class="container-fluid bg-white mt-5">
        <div class="row">
          <div class="col-lg-4 p-4">
            <h3 class="h-font fw-bold fs-3 mb-2">Paradiso Hotel</h3>
            <p>
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Laboriosam, ea officia? 
              Repellat nisi optio accusamus labore assumenda doloremque? Voluptas itaque incidunt modi reiciendis, quasi placeat odit at assumenda ducimus aliquid!
            </p>
          </div>
          <div class="col-lg-4 p-4">
      ...
      <h6 class="text-center bg-dark text-white p-3 m-0">Designed and Developed by Kelompok PROWEB 5</h6>
      <h6 class="text-center bg-dark text-white p-3 m-0">Our Gratitude: <a class="text-decoration-none" href="https://www.youtube.com/@tj_webdev">TJ Webdev Channel</a></h6>
