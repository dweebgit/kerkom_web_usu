        ...
        <div class="container">
            <div class="row justify-content-between align-itmes-center">
                <div class="col-lg-6 col-md-5 mb-4 order-lg-1 order-md-1 order-2">
                    ...
                    <p>
                        Lorem ipsum dolor sit amet consectetur, adipisicing elit. Enim molestias veritatis eum eaque ab ullam rem.
                        Lorem ipsum dolor sit amet consectetur, adipisicing elit. Enim molestias veritatis eum eaque ab ullam rem.
        ...
        <div class="container mt-5">
            <div class="row">
                <div class="col-lg-3 col-md-6 mb-4 px-4">
                    <div class="bg-white rounnded shadow p-4 border-top border-4 text-center box">
                ...
                <div class="col-lg-3 col-md-6 mb-4 px-4">
                    <div class="bg-white rounnded shadow p-4 border-top border-4 text-center box">
                        <img src="images/about/customer.svg" width="70px" alt="">
